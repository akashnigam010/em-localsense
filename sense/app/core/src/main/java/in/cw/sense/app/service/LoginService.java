...
public class LoginService {
	...
	Sms sms;
	@Autowired
	CloudConnectService cloudService;
	...
	@RequestMapping(value = "/handShake", method = RequestMethod.GET, headers = "Accept=application/json")
	public String handShake() {

		String helloWorldMessage = "Hello world from hand shake!";
		cloudService.handShake();
		return helloWorldMessage;
	}
	
	@RequestMapping(value = "/sendBill", method = RequestMethod.GET)
	public String test() {
